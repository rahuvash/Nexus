...
const Home1 = () => {
  return (
    <div>
      <div className="alert__banner">
        <p>
          Trained Aesop consultations are available to provide bespoke SkinCare
          advise.{" "}
          <a
      ...
      <div className="home1">
        ...
        <header className="header__content">
          ...
          <p>
            ...
            <br /> Polish and Refresh—three additions to the range,
            <br /> each imparting a unique constellation of benefits.
          </p>
        </header>
        <br />
